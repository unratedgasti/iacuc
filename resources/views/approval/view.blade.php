			...
			<div class="row">
				...
				<div class="span12">
					...
					<div class="widget">
						...
						{{ Form::open(array('url' => '/approvals/save-review/'.$prf_details->protocol_id, 'method' => 'post', 'enctype' => 'multipart/form-data', 'class'=>'form-label-left')) }}
						...
						<div class="widget-content">
								...
								<span class="pull-right">
									<strong><a href="{{url('/approvals/generate-forms/'.$prf_details->protocol_id)}}" style="color:rgb(0, 132, 255);">GENERATE FORMS</a></strong>
								</span>
							</div>
								@endif
							...
							<div class="tab-content">
								<div class="tab-pane active" id="protocol">
									...
									<fieldset>
											...
											<br /> 
											@if($prf_status->description<>'FOR APPROVAL SECRETARY')	
											<div class="control-group">	
										...
										<div class="form-actions" align="center">
											<a href="{{url('/approvals/process-approval/'.$prf_details->protocol_id)}}" class="btn btn-primary">PROCESS PRF APPROVAL</a> 									
											<a  class="btn btn btn-medium btn-info btnNext" >NEXT</a>
										</div> <!-- /form-actions -->
										@endif
									</div>
									...
									<div class="tab-pane" id="objectives">
										<fieldset>
											...
											<div class="control-group">	
												<label class="control-label" for="email"><strong>COMMENTS</strong></label>
												<div class="controls">
													<textarea class="form-control span10"  name="objectives_comments" rows="8"></textarea>
												</div>
											</div>
											@endif
										</br>
										...
										<div class="control-group">	
											<label class="control-label" for="email"><strong>COMMENTS</strong></label>
											<div class="controls">
												<textarea class="form-control span10"  name="duration_comments" rows="8"></textarea>
											</div>
										</div>
										@endif
										<br />
								...
								<div class="tab-pane" id="pi">
									...
									<fieldset>
										...
										@if(!in_array(4,getUserRole()))	
										<div class="control-group">	
											<label class="control-label" for="email"><strong>COMMENTS</strong></label>
											<div class="controls">
												<textarea class="form-control span10"  name="investigator_comments" rows="8"></textarea>
											</div>
										</div>
										@endif
										<br />
										...
										<div class="control-group">	
											<label class="control-label" for="email"><strong>COMMENTS</strong></label>
											<div class="controls">
												<textarea class="form-control span10"  name="background_comments" rows="8"></textarea>
											</div>
										</div>
										@endif
										<br />
								...
								<div class="tab-pane" id="description" >
									...
									<fieldset>
										...
										<div class="control-group">	
											<label class="control-label" for="email"><strong>COMMENTS</strong></label>
											<div class="controls">
												<textarea class="form-control span10"  name="animals_comments" rows="8"></textarea>
											</div>
										</div>
										@endif
										<br/>
										...
										<div class="control-group">	
											<label class="control-label" for="email"><strong>COMMENTS</strong></label>
											<div class="controls">
												<textarea class="form-control span10"  name="basis_comments" rows="8"></textarea>
											</div>
										</div>
										@endif
										<br />
										...
										<div class="control-group">	
											<label class="control-label" for="email"><strong>COMMENTS</strong></label>
											<div class="controls">
												<textarea class="form-control span10"  name="quarantine_comments" rows="8"></textarea>
											</div>
										</div>
										@endif
										<br />
										...
										<div class="control-group">											
											...
											<div class="control-group">	
												<label class="control-label" for="email"><strong>COMMENTS</strong></label>
												<div class="controls">
													<textarea class="form-control span10"  name="cage_comments" rows="4"></textarea>
												</div>
											</div>
											@endif
											...
											<div class="control-group">	
												<label class="control-label" for="email"><strong>COMMENTS</strong></label>
												<div class="controls">
													<textarea class="form-control span10"  name="numanimals_comments" rows="4"></textarea>
												</div>
											</div>
											@endif
											...
											<div class="control-group">	
												<label class="control-label" for="email"><strong>COMMENTS</strong></label>
												<div class="controls">
													<textarea class="form-control span10"  name="identification_comments" rows="4"></textarea>
												</div>
											</div>
											@endif
											...
											<div class="control-group">	
												<label class="control-label" for="email"><strong>COMMENTS</strong></label>
												<div class="controls">
													<textarea class="form-control span10"  name="cageclean_comments" rows="4"></textarea>
												</div>
											</div>
											@endif
											...
											<div class="control-group">	
												<label class="control-label" for="email"><strong>COMMENTS</strong></label>
												<div class="controls">
													<textarea class="form-control span10"  name="living_comments" rows="4"></textarea>
												</div>
											</div>
											@endif
											...
											<div class="control-group">	
												<label class="control-label" for="email"><strong>COMMENTS</strong></label>
												<div class="controls">
													<textarea class="form-control span10"  name="diet_comments" rows="4"></textarea>
												</div>
											</div>
											@endif
										</div>
										...
										<div class="control-group">											
											...
											<div class="control-group">	
												<label class="control-label" for="email"><strong>COMMENTS</strong></label>
												<div class="controls">
													<textarea class="form-control span10"  name="general_comments" rows="4"></textarea>
												</div>
											</div>
											@endif
											...
											<div class="control-group">	
												<label class="control-label" for="email"><strong>COMMENTS</strong></label>
												<div class="controls">
													<textarea class="form-control span10"  name="location_comments" rows="4"></textarea>
												</div>
											</div>
											@endif
											...
											<div class="control-group">	
												<label class="control-label" for="email"><strong>COMMENTS</strong></label>
												<div class="controls">
													<textarea class="form-control span10"  name="dosing_comments" rows="4"></textarea>
												</div>
											</div>
											@endif
											...
											<div class="control-group">	
												<label class="control-label" for="email"><strong>COMMENTS</strong></label>
												<div class="controls">
													<textarea class="form-control span10"  name="collection_comments" rows="4"></textarea>
												</div>
											</div>
											@endif
											...
											<div class="control-group">	
												<label class="control-label" for="email"><strong>COMMENTS</strong></label>
												<div class="controls">
													<textarea class="form-control span10"  name="examination_comments" rows="4"></textarea>
												</div>
											</div>
											@endif
											...
											<div class="control-group">	
												<label class="control-label" for="email"><strong>COMMENTS</strong></label>
												<div class="controls">
													<textarea class="form-control span10"  name="anesthetics_comments" rows="4"></textarea>
												</div>
											</div>
											@endif
											...
											<div class="control-group">	
												<label class="control-label" for="email"><strong>COMMENTS</strong></label>
												<div class="controls">
													<textarea class="form-control span10"  name="surgical_comments" rows="4"></textarea>
												</div>
											</div>
											@endif
											...
											<div class="control-group">	
												<label class="control-label" for="email"><strong>COMMENTS</strong></label>
												<div class="controls">
													<textarea class="form-control span10"  name="humane_comments" rows="4"></textarea>
												</div>
											</div>
											@endif
										...
										<div class="control-group">	
											<label class="control-label" for="email"><strong>COMMENTS</strong></label>
											<div class="controls">
												<textarea class="form-control span10"  name="hazards_comments" rows="4"></textarea>
											</div>
										</div>
										@endif
										<br />
										...
										<div class="control-group">	
											<label class="control-label" for="email"><strong>COMMENTS</strong></label>
											<div class="controls">
												<textarea class="form-control span10"  name="disposal_comments" rows="4"></textarea>
											</div>
										</div>
										@endif
										<br />
										...
										<div class="control-group">	
											<label class="control-label" for="email"><strong>COMMENTS</strong></label>
											<div class="controls">
												<textarea class="form-control span10"  name="alternative_comments" rows="4"></textarea>
											</div>
										</div>
										@endif
										<br />
									...
									<div class="control-group">	
										<label class="control-label" for="email"><strong>COMMENTS</strong></label>
										<div class="controls">
											<textarea class="form-control span10"  name="personnel_comments" rows="4"></textarea>
										</div>
									</div>
									@endif
										@if($prf_status->description<>'FOR APPROVAL SECRETARY')	
								...
								<div class="tab-pane" id="reference">
									...
									<fieldset>
										...
										<div class="control-group">	
											<label class="control-label" for="email"><strong>COMMENTS</strong></label>
											<div class="controls">
												<textarea class="form-control span10"  name="references_comments" rows="4"></textarea>
											</div>
										</div>
										@endif
										<br />

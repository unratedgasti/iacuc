			...
			<div class="row">
				...
				<div class="span12">
					...
					<div class="widget">
						...
						<input type="hidden" name="review_id" id="review_id" value="{{$review_details->id}}">
							...
							<div class="tab-content">
								<div class="tab-pane active" id="protocol">
									...
									<div class="form-actions" align="center">
										...
										<button type="submit" class="btn btn-primary" style="">Save it for later</button>
										<button type="button" class="btn btn-danger" id="return1">Return to Investigator</button> 
										<button type="button" class="btn btn-success" id="approve1">Approve</button> 
										<a  class="btn btn btn-medium btn-info btnNext" >NEXT</a>
									</div> <!-- /form-actions -->
								</div>
								...
								<div class="tab-pane" id="pi">
									...
									<div class="form-actions" align="center">
										<a  class="btn btn btn-medium btn-info btnPrev" >PREVIOUS</a>
										<button type="submit" class="btn btn-primary" style="">Save it for later</button>
										<button type="button" class="btn btn-danger" id="return2">Return to Investigator</button> 
										<button type="button" class="btn btn-success" id="approve2">Approve</button> 
										<a  class="btn btn btn-medium btn-info btnNext" >NEXT</a>
									</div> <!-- /form-actions -->
								...
								<div class="tab-pane" id="description" >
									...
									<div class="form-actions" align="center">
										<a  class="btn btn btn-medium btn-info btnPrev" >PREVIOUS</a>
										<button type="submit" class="btn btn-primary" style="">Save it for later</button>
										<button type="button" class="btn btn-danger" id="return3">Return to Investigator</button> 
										<button type="button" class="btn btn-success" id="approve3">Approve</button> 
										<a  class="btn btn btn-medium btn-info btnNext" >NEXT</a>
									</div> <!-- /form-actions -->
								</div>
								...
								<div class="tab-pane" id="reference">
									...
									<fieldset>
										...
										<a  class="btn btn btn-medium btn-info btnPrev" >PREVIOUS</a>
										<button type="submit" class="btn btn-primary" style="">Save it for later</button>
										<button type="button" class="btn btn-danger" id="return4">Return to Investigator</button> 
										<button type="button" class="btn btn-success" id="approve4">Approve</button> 
									</div> <!-- /form-actions -->
									</fieldset>

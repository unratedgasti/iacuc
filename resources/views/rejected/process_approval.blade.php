						...
						<div class="widget-content" align="center">
							<div class="control-group">											
								...
								<div class="controls">
									...
									<label class="radio inline" style="padding-left: 70px!important;">
										<input type="radio" name="radiobtns" value="Rejected"> Rejected
									</label>
								</div>	<!-- /controls -->			
							</div> <!-- /control-group -->
							<br/>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$("#but_upload").change(function () {
			var fileExtension = ['rar', 'RAR', 'pdf', 'PDF'];
        ...
        if(files.length > 0 ){
        	...
        	$.ajax({
        		...
        		success: function(response){
        			...
        			if(response != 0){
        				$("#attachments").append('<div class="attach"><strong>'+filename+'</strong>&nbsp;&nbsp;&nbsp;<input type="hidden" name="att_id" value="'+response+'" id="remove" ><a href = "#" class="remove"  style="color:red"><i class="icon-remove remov" ></i></a><br/><div>');
        			}else{

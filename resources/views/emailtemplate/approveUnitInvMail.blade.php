...
Dear <strong>{{ $prf_details->honorifics }} {{$prf_details->inv_name}}</strong>,<br><br>
Your research protocol entitled <strong>{{$prf_details->protocol_name}}</strong> has undergone preliminary review and has been forwarded by your 
<br>Institute’s Representative to be reviewed en banc.<br><br>

You will be notified of the results of the evaluation after the next IACUC meeting.
